  ...
  return [
    {
      ...
      category: '数据展示',
      content: `<style>
.el-table{width:100%;font-family:"Microsoft YaHei","PingFang SC",sans-serif;box-sizing:border-box}
.el-table table{width:100%;border-collapse:collapse;font-size:${px(14)}}
.el-table thead th{padding:${px(14)} ${px(16)};text-align:left;font-weight:600;color:${C.text};background:${C.bg};border-bottom:1px solid ${C.border};white-space:nowrap}
.el-table tbody td{padding:${px(12)} ${px(16)};color:${C.textSecondary};border-bottom:1px solid ${C.borderLight};transition:background .12s}
.el-table tbody tr{transition:background .12s}
.el-table tbody tr:hover td{background:#f5f7fa}
.el-table tbody tr:last-child td{border-bottom:none}
.el-table .el-tag{display:inline-block;padding:${px(1)} ${px(8)};font-size:${px(12)};border-radius:${px(3)};line-height:1.8}
</style>
<div data-gjs-type="el-table" class="el-table" style="background:${C.bgWhite};border:1px solid ${C.border};border-radius:${C.radius};overflow:hidden;">
  <table>
    <thead>
      <tr>
        <th>产品名称</th>
